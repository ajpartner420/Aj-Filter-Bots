...
MELCOW_VID = environ.get("MELCOW_VID", "https://t.me/+q3FAzjyXMDo1ZDhl")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001992347854').split()]
...
URL = "https://aj-moviebook.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://aj-moviebook.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://aj-moviebook.onrender.com/".format(FQDN)
else:
    URL = "https://aj-moviebook.onrender.com/".format(FQDN)
